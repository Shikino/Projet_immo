<?php
class ViewNouveauMdp
{
    public static function NouveauMdp($mail)
    {
?>
        ...
        <div class=" container  mt-3">
            ...
            <div class="row ">
                ...
                <div class="col-6  ">
                    ...
                    <form name="ajout_user" id="formnewmdp" method="post" action="<?php echo adresseRoot . "ControllerVerificationNewMdp.php?mail=".$mail ?>" enctype="multipart/form-data">
    ...
    <div class=" container  mt-3">
        ...
        <div class="row ">
            ...
            <div class="col-6  ">
                ...
                <form name="ajout_user" id="formMailMdp" method="post" action="<?php echo "../controller/ControllerVerificationMail.php" ?>" enctype="multipart/form-data">
